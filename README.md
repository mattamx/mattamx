...
Aiming to start a new career that lets me utilize a combination of my four core pillars: 1) Python, 2) ML, 3) SQL and 4) Tableau. Ready and willing to start from the very bottom and work my way up, time flies by when you're having fun with what you do.
