...
Aiming to jump into a role that allows me to utilize a combination of my four core pillars: 1) Python, 2) ML, 3) SQL and 4) Tableau and lets me incorporate the skills I acquired in Business Management/Strategy. Ready and willing to start from the very bottom and work my way up, time flies by when you're having fun.
